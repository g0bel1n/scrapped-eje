...
FastFashion =['ZARA','VANS','AIRNESS' ,'TOMMY','PUMA','NEW BALANCE','ELLESSE','LE TEMPS DES CERISES', 'SKETCHERS','VANESSA WU', 'H&M', 'BERSHKA', 'FOREVER21', 'MANGO', 'TOPSHOP', 'UNIQLO', 'URBAN OUTFITTER', 'GAP', 'PEPE JEANS', 'BONS BAISERS DE PANAME', 'KAPORAL','GUESS',  'LA PETITE FRANCAISE', 'PULL & BEAR', 'PROMOD', 'ARTENGO', 'FILA', 'NIKE', 'CONVERSE', 'ADIDAS','UNIQLO' 'ASICS', 'REEBOK', 'GÉMO', 'SERGIO ROSSI', 'LIBERTO', 'GEOX', 'KAPPA', 'HEELYS', 'NAF NAF', "LEVI'S", 'REEBOK', "TAPE À L'OEIL", 'PIMKIE', 'JENNYFER', 'CAMAÏEU', 'SERGIO TACCHINI']
#Prix Max < 50

Fashion=['ACNE', 'SUPERDRY', 'DC', 'JORDAN','SANDRO', 'LACOSTE', 'VEJA', 'CARHART','RALPH LAUREN','KENZO','COMME DES GARÇONS']
#Prix Max < 100

UltraFashion = ['PALM','ANINE BING','SUPREME','VIVIENNE WESTWOOD','OFF-WHITE','YEEZY','STONE ISLAND','JEAN PAUL GAULTIER','FEAR OF', 'SANTONI','GIUSEPPE ZANOTTI','HOGAN','KARL LAGERFELD', 'STEVE MADDEN',  'VALENTINO', 'DIESEL' , 'FEAR OF GOD ESSENTIALS', 'TRUE RELIGION', 'ISABEL MARANT', 'VALENTINO GARAVANI', 'LOUIS VUITTON', 'SAINT LAURENT',  'POLO RALPH LAUREN', 'DR. MARTENS', 'LOEFFLER RANDALL', 'CARVEN', 'MOSCHINO', 'HARRYS OF LONDON', 'PIERRE HARDY', 'LE LISSIER']
# Prix Max > 300

Luxe = ['JACQUEMUS','VERSACE','GIVENCHY', 'FENDI','PRADA', 'DIOR','BALENCIAGA', 'DOLCE & GABBANA','PHILIPP PLEIN', 'BURBERRY',  'GUCCI', 'VERSACE', 'D&G', 'PRADA', 'CHANEL','YVES SAINT LAURENT','BALMAIN','DSQUARED2', 'AMIIRI', 'Y/PROJECT'] 
# Prix Min > 300
...
def categoriseMarque(row: pd.Series)->str:
    ...
    elif row['Marque'] in Luxe or any(marqueTest in row['Marque'] for marqueTest in Luxe): return 'Luxe'
